...
export class AdditionalRequirementEditor extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            formData: {
                id: props.req.id || "",
                description: props.req.description || "", 
                semester: props.req.semester || "", 
                prefix: props.req.prefix || "",
                number: props.req.number || "",
                grade: props.req.grade || ""
            }
        }
    }
